...
const StatsTable = ({ tableObject, isMonsterBased = false }) => {
  return (
    <div className='bg-neutral-950/50 rounded-md border border-neutral-700 overflow-auto max-h-[500px] mt-2'>
      <table className='w-full text-left border-collapse'>
        <caption className='caption-top bg-neutral-900/80 py-4 px-4 text-left text-2xl text-amber-500 border-b border-neutral-700 witcher-font tracking-wide'>
          {tableObject.caption}
        </caption>        <thead className='bg-neutral-900'>
