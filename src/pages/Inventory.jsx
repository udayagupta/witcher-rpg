...
const Inventory = () => {
  ...
  const categoryBtnClass = `min-w-[120px] text-sm lg:text-md text-amber-300 bg-neutral-800 cursor-pointer font-extrabold p-2 rounded-md flex-1 transition hover:bg-amber-300 hover:text-neutral-800`;
  const selectedBtnClass = `min-w-[120px] text-sm lg:text-md bg-amber-300 text-neutral-800 cursor-pointer font-extrabold p-2 rounded-md flex-1 transition`
